...
public:
	...
	// nap chong toan tu bat buoc phai tham chieu  
	friend bool operator < (Hinh2D&a,Hinh2D&b);
	friend bool operator > (Hinh2D&a,Hinh2D &b); 
	friend istream& operator >> (istream& inputStream,Hinh2D& h2d);
	friend ostream& operator << (ostream& outputStream,Hinh2D& h2d);
private:
	string mausac;
};

bool operator < (Hinh2D&a,Hinh2D&b){
...
int main()
{
	...
	cout<<"Tong dien tich cac hinh vua nhap la: "<<sum;
...
istream& operator >> (istream& inputStream,Hinh2D& h2d){
	h2d.nhap();
	return inputStream;
}
ostream& operator << (ostream& outputStream,Hinh2D& h2d){
	h2d.xuat();
	return outputStream;
}
